...
#      print(period) # debug
   ...
   apiUrl = f"https://api.telegram.org/bot{ app_secrets.telegram_bot_token }/sendMessage?chat_id={ app_secrets.telegram_bot_chat_id }&parse_mode=Markdown{ disable_notification_param }&text={ bot_message }"
