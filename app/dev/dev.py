...
def get_species_dates(taxon, year):
    ...
    limit = 10000
    url = f"https://api.laji.fi/warehouse/query/unit/list?selected=gathering.conversions.dayOfYearBegin%2Cgathering.conversions.dayOfYearEnd%2Cgathering.conversions.wgs84CenterPoint.lat%2Cgathering.conversions.wgs84CenterPoint.lon&orderBy=gathering.conversions.dayOfYearBegin&pageSize={ limit }&page=1&cache=true&taxonId={ taxon }&useIdentificationAnnotations=true&includeSubTaxa=true&includeNonValidTaxa=true&countryId=ML.206&time={ year }&collectionIdNot=HR.48&individualCountMin=1&qualityIssues=NO_ISSUES"
