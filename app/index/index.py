...
def get_today_saved_total():
    ...
    data = common_helpers.fetch_finbif_api(f"https://api.laji.fi/warehouse/query/unit/aggregate?countryId=ML.206&aggregateBy=document.collectionId&selected=document.collectionId&cache=true&page=1&pageSize=100&firstLoadedSameOrAfter={today}&geoJSON=false&onlyCount=false")
